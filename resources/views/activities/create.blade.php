@extends('layouts.app')
@section('title', 'Add Activity — Wanderly')
...
<div class="form-page">
    <div class="form-page-header">
        ...
        <h1>Add Activity 🎯</h1>
        <p class="header-subtitle">Add something fun, delicious, or adventurous!</p>
    </div>

    <div class="form-card">
        @include('components.errors')

        <form action="{{ route('trips.activities.store', $trip->_id) }}" method="POST" class="trip-form">
            @csrf

            <div class="form-section">
                <div class="form-section-header">
                    <span class="section-num">01</span>
                    <div><h2>Activity Details</h2><p>What's the plan?</p></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="activity_name" name="activity_name"
                        ...
                        placeholder="e.g. Eiffel Tower Visit, Sushi Dinner, Snorkeling..." required maxlength="255">
                    ...
                    <div class="category-grid">
                        ...
                        <label class="category-option">
                            <input type="radio" name="category" value="{{ $cat['value'] }}"
                                {{ old('category', 'sightseeing') === $cat['value'] ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description"
                        ...
                        placeholder="What will you do there? Any special notes..."
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="location" name="location"
                        ...
                        placeholder="e.g. Champ de Mars, Paris" maxlength="255">
                </div>
            </div>
            ...
            <div class="form-section">
                <div class="form-section-header">
                    ...
                    <div><h2>Date &amp; Time</h2><p>When is this happening?</p></div>
                </div>
                ...
                <div class="form-row-2">
                    <div class="form-group">
                        ...
                        <input type="date" id="activity_date" name="activity_date"
                            ...
                            value="{{ old('activity_date', request('date', $trip->start_date?->format('Y-m-d'))) }}"
                    ...
                    <div class="form-group">
                        <label for="activity_time" class="form-label">Time <span class="optional">(optional)</span></label>
                        <input type="time" id="activity_time" name="activity_time"
                            class="form-input" value="{{ old('activity_time') }}">
                    </div>
                </div>

                <div class="form-group" style="max-width: 260px;">
                    <label for="duration_minutes" class="form-label">Duration (minutes) <span class="optional">(optional)</span></label>
                    <input type="number" id="duration_minutes" name="duration_minutes"
                        class="form-input" value="{{ old('duration_minutes') }}"
            ...
            <div class="form-section">
                ...
                <div class="form-row-2">
                    <div class="form-group">
                        <label for="cost" class="form-label">Cost (INR) <span class="optional">(optional)</span></label>
                        <div class="input-with-prefix">
                            <span class="input-prefix">₹</span>
                            <input type="number" id="cost" name="cost"
                                class="form-input with-prefix" value="{{ old('cost') }}"
                                placeholder="50" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="booking_reference" class="form-label">Booking Reference <span class="optional">(optional)</span></label>
                        <input type="text" id="booking_reference" name="booking_reference"
                            class="form-input" value="{{ old('booking_reference') }}"
                            placeholder="e.g. TK9876543" maxlength="100">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="checkbox-label">
                        <input type="checkbox" name="booking_required" value="1"
                            {{ old('booking_required') ? 'checked' : '' }}>
                        <span class="checkmark"></span>
                        Booking / reservation required for this activity
                    </label>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    <label for="notes" class="form-label">Additional Notes <span class="optional">(optional)</span></label>
                    <textarea id="notes" name="notes" class="form-input form-textarea"
                        placeholder="Dress code, what to bring, access instructions..."
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn-submit">
                    <i class="bi bi-lightning-charge"></i> Add Activity
                </button>
            </div>
        </form>
    </div>
