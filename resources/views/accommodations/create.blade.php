@extends('layouts.app')
@section('title', 'Add Accommodation — Wanderly')
...
<div class="form-page">
    <div class="form-page-header">
        ...
        <p class="header-subtitle">Add your hotel, hostel, or Airbnb details</p>
    </div>

    <div class="form-card">
        @include('components.errors')

        <form action="{{ route('trips.accommodations.store', $trip->_id) }}" method="POST" class="trip-form">
            @csrf

            <div class="form-section">
                <div class="form-section-header">
                    <span class="section-num">01</span>
                    <div><h2>Property Details</h2><p>Where will you be staying?</p></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="hotel_name" name="hotel_name"
                        ...
                        value="{{ old('hotel_name') }}" placeholder="e.g. The Ritz Paris" required maxlength="255">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="address" name="address"
                        ...
                        value="{{ old('address') }}" placeholder="Street address..." maxlength="500">
                ...
                <div class="form-row-2">
                    <div class="form-group">
                        ...
                        <input type="text" id="city" name="city"
                            class="form-input" value="{{ old('city') }}" placeholder="Paris" maxlength="100">
                    </div>
                    <div class="form-group">
                        <label for="country" class="form-label">Country</label>
                        <input type="text" id="country" name="country"
                            class="form-input" value="{{ old('country') }}" placeholder="France" maxlength="100">
                    </div>
                </div>
                ...
                <div class="form-row-2">
                    <div class="form-group">
                        ...
                        <input type="text" id="room_type" name="room_type"
                            class="form-input" value="{{ old('room_type') }}" placeholder="e.g. Deluxe Double" maxlength="100">
                    </div>
                    <div class="form-group">
                ...
                <div class="form-row-2">
                    <div class="form-group">
                        ...
                        <input type="date" id="check_in" name="check_in"
                            ...
                            value="{{ old('check_in', $trip->start_date?->format('Y-m-d')) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="check_out" name="check_out"
                            ...
                            value="{{ old('check_out', $trip->end_date?->format('Y-m-d')) }}"
                            min="{{ $trip->start_date?->format('Y-m-d') }}"
                            max="{{ $trip->end_date?->format('Y-m-d') }}" required>
                ...
                <div class="form-row-2">
                    <div class="form-group">
                        ...
                        <div class="input-with-prefix">
                            ...
                            <input type="number" id="price_per_night" name="price_per_night"
                                class="form-input with-prefix" value="{{ old('price_per_night') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="booking_reference" name="booking_reference"
                            ...
                            placeholder="e.g. BK1234567" maxlength="100">
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea id="notes" name="notes" class="form-input form-textarea"
                        placeholder="Check-in instructions, amenities, parking info..."
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn-submit">
                    <i class="bi bi-building"></i> Add Accommodation
                </button>
            </div>
        </form>
    </div>
